...
# config.py — extend your existing PATTERN_MAP
PATTERN_MAP = {
    # Payment timeout
    "GW_TIMEOUT_503":          "payment_timeout",
    "GW_CONNECT_REFUSED":      "payment_timeout",
    "PAYMENT_SVC_UNAVAILABLE": "payment_timeout",
    "GATEWAY_TIMEOUT":         "payment_timeout",   # ← LLM-extracted variant
    "PAYMENT_TIMEOUT":         "payment_timeout",   # ← LLM-extracted variant
    "GW_TIMEOUT":              "payment_timeout",   # ← LLM-extracted variant
    "CONNECTION_TIMEOUT":      "payment_timeout",   # ← LLM-extracted variant
