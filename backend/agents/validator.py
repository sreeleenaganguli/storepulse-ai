...
def run_validator(state: AgentState) -> dict:
    event_start = {"type":"agent_step","agent":"validator","status":"running",
    ...
    if passed:
        event_done = {"type":"validated","agent":"validator","status":"done",
                      "message":"All 8 validation rules passed ✓"}
    elif hard_fail:
        event_done = {"type":"validation_failed","agent":"validator","status":"failed",
